...
Rails.application.configure do
  ...
  SecureHeaders::Configuration.default do |config|
    ...
    config.csp = {
      ...
      child_src: %w[https://js.stripe.com https://jprymo.com/blogs/sketchblog], # if child-src isn't supported, the value for frame-src will be set.
      ...
      manifest_src: %w[self],
      object_src: %w[self],
      script_src: %w[https://unpkg.com https://cdn.jsdelivr.net https://js.stripe.com
                     sha256-1Q6bF/nHqN4SA3xlhz5S2s4rB9gpkDESG4eHQkc15TY= sha256-Oe+qaAOnWbHzwKTQckF85lGda0rAVJCeqHpzWZ17BOA= self],
